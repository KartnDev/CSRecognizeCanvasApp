...
using RecognizeWinAppML.Model.DataModels;

namespace RecognizeWinAppML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\dmutp\source\repos\RecognizeWinApp\RecognizeWinApp\train.csv";
        private static string MODEL_FILEPATH = @"../../../../RecognizeWinAppML.Model/MLModel.zip";
